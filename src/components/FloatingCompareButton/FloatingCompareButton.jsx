...
const FloatingCompareButton = ({ 
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`} data-testid="floating-compare-button-container" {...props}>
      <button
        onClick={onClick}
        ...
        data-testid="floating-compare-button"
      >
        <div className="flex items-center space-x-2" data-testid="floating-compare-button-content">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" data-testid="floating-compare-button-icon">
        ...
        {/* Badge */}
        {compareCount > 0 && (
          <div className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center animate-pulse" data-testid="floating-compare-button-badge">
